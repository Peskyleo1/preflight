            ...
            <div className="container d-flex align-items-center flex-column">
                ...
                <div class="row pasa-row">
                    <div class="col-lg-4 ml-auto pasa-column">
                        ...
                        <input className="pasa-textfield dark" id="result-deIcing4" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.DeIcingFluid4_Result ? (Res.DeIcingFluid4_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TOTAL EMPTY MASS</p>
                        <input className="pasa-textfield dark" id="result-totalEmptyMass" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.TotalEmptyMass_Result ? (Res.TotalEmptyMass_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TAKEOFF FUEL (in Main Tanks)</p>
                        <input className="pasa-textfield dark" id="result-TOFuelMain" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.TOFuelKgMain_Result ? (Res.TOFuelKgMain_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">LANDING FUEL (in Main Tanks)</p>
                        <input className="pasa-textfield dark" id="result-LdgFuelMain" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.LdgFuelKgMain_Result ? (Res.LdgFuelKgMain_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TAKEOFF FUEL (in Auxiliary Tanks)</p>
                        <input className="pasa-textfield dark" id="result-TOFuelAux" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.TOFuelKgAux_Result ? (Res.TOFuelKgAux_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">LANDING FUEL (in Auxiliary Tanks)</p>
                        <input className="pasa-textfield dark" id="result-LdgFuelAux" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.LdgFuelKgAux_Result ? (Res.LdgFuelKgAux_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TOTAL TAKEOFF MASS</p>
                        <input className="pasa-textfield dark" id="result-TotalMassTO" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.TotalMassTO_Result ? (Res.TotalMassTO_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TOTAL LANDING MASS</p>
                        <input className="pasa-textfield dark" id="result-TotalMassLdg" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.TotalMassLdg_Result ? (Res.TotalMassLdg_Result).toFixed(2) : null} disabled/>
                    </div>
                    <div class="col-lg-4 mr-auto pasa-column">
                        ...
                        <input className="pasa-textfield dark" id="result-rearSeatsMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.RearSeatsMoment_Result ? (Res.RearSeatsMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">NOSE BAGGAGE MOMENT</p>
                        <input className="pasa-textfield dark" id="result-noseBaggageMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.NoseBaggageMoment_Result ? (Res.NoseBaggageMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">CABIN BAGGAGE MOMENT</p>
                        <input className="pasa-textfield dark" id="result-cabinBaggageMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.CabinBaggageMoment_Result ? (Res.CabinBaggageMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">BAGGAGE EXTENSION MOMENT</p>
                        <input className="pasa-textfield dark" id="result-baggageExtensionMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.BaggageExtensionMoment_Result ? (Res.BaggageExtensionMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">STANDARD BAGGAGE MOMENT</p>
                        <input className="pasa-textfield dark" id="result-standardBaggageMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.StandardBaggageMoment_Result ? (Res.StandardBaggageMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">SHORT BAGGAGE EXTENSION MOMENT</p>
                        <input className="pasa-textfield dark" id="result-shortBaggageMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.ShortBaggageMoment_Result ? (Res.ShortBaggageMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">DE-ICING FLUID @ 1m MOMENT</p>
                        <input className="pasa-textfield dark" id="result-deIcingMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.DeIcingFluidMoment_Result ? (Res.DeIcingFluidMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">DE-ICING FLUID @ 4.52m MOMENT</p>
                        <input className="pasa-textfield dark" id="result-deIcingMoment4" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.DeIcingFluid1Moment_Result ? (Res.DeIcingFluid1Moment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TOTAL EMPTY MOMENT</p>
                        <input className="pasa-textfield dark" id="result-totalEmptyMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.TotalMomentEmpty_Result ? (Res.TotalMomentEmpty_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TAKEOFF FUEL MOMENT (Main Tanks)</p>
                        <input className="pasa-textfield dark" id="result-TOFuelMainMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.TOMainTanksMoment_Result ? (Res.TOMainTanksMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">LANDING FUEL MOMENT (Main Tanks)</p>
                        <input className="pasa-textfield dark" id="result-LdgFuelMainMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.LdgMainTanksMoment_Result ? (Res.LdgMainTanksMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TAKEOFF FUEL MOMENT (Auxiliary Tanks)</p>
                        <input className="pasa-textfield dark" id="result-TOFuelAuxMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.TOAuxTanksMoment_Result ? (Res.TOAuxTanksMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">LANDING FUEL MOMENT (Auxiliary Tanks)</p>
                        <input className="pasa-textfield dark" id="result-LdgFuelAuxMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.LdgAuxTanksMoment_Result ? (Res.LdgAuxTanksMoment_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TOTAL TAKEOFF MOMENT</p>
                        <input className="pasa-textfield dark" id="result-totalMassTOMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.TotalMomentTO_Result ? (Res.TotalMomentTO_Result).toFixed(2) : null} disabled/>
                        <p className="pasa-paragraph result">TOTAL LANDING MOMENT</p>
                        <input className="pasa-textfield dark" id="result-totalMassLdgMoment" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kgm"  autocomplete="off" value={Res.TotalMomentLdg_Result ? (Res.TotalMomentLdg_Result).toFixed(2) : null} disabled></input>
                    </div>
                </div>
                <br></br><br></br><br></br><br></br>
                <p className="pasa-paragraph result">KG OF FUEL TRANSFERRED FROM AUXILIARY TO MAIN TANKS</p>
                <input className="pasa-textfield dark" id="result-transferredFuel" type="text" inputmode="decimal" pattern="[0-9]+([\.,][0-9]+)?" placeholder="RESULT: kg"  autocomplete="off" value={Res.TransferredFuel_Result ? (Res.TransferredFuel_Result).toFixed(2) : null} disabled></input>
